...
const Navbar = ({ theme, lightMode, darkMode }) => {
  ...
  return (
    <>
      {dropDownMenu ? (
        <div className="bg-white border-b fixed border-gray-400 dark:bg-black shadow-xl dark:bg-opacity-50 h-60  w-full z-50  items-center -motion-translate-y-in-100">
          <div className="mt-5  flex flex-col gap-5 items-center p-5">
            <button className="hover:bg-gray-100 dark:hover:bg-gray-900 w-full p-2 rounded-lg duration-100">
              Home
            </button>
            <button className="hover:bg-gray-100 dark:hover:bg-gray-900 w-full p-2 rounded-lg duration-100">
              Contact
